...
import { IIamService } from '../../core/interfaces/services/iam.service.interface';
import type { IRoleRepository } from '../../core/interfaces/repositories/role.repository.interface';
import type { IUserRepository } from '../../core/interfaces/repositories/user.repository.interface';
import type { IPermissionRepository } from '../../core/interfaces/repositories/permission.repository.interface';
import type {IHashingService} from '../../core/interfaces/services/hashing.service.interface'
...
export class IamService implements IIamService{
    ...
    async createUser(email: string, password: string, fullName: string, phoneNumber: string, roleCode?: string, baseSalary?: number, salaryType?: string, warehouseIds?: string[]): Promise<User> {
        ...
        const userDto = { email, fullName, phoneNumber } as any; 
